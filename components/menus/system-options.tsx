      ...
      <PopoverContent className="px-2 py-1 border-none min-w-[280px]">
        <ul className="text-sm divide-y flex flex-col gap-[1px]">
          <Button
            ...
            {showModules && (
              <section
                className={`p-1 absolute top-[-30px] ${side}-[calc(100%+5px)] divide-y mr-1 dark:bg-black shadow-md rounded-md border w-[200px] z-10 pop-bg`}>
                {data?.map((module) => (
                  <Link
          ...
          <li
            ...
            {showSubmenu && (
              <section
                className={`p-1 absolute top-[-35px] ${side}-[calc(100%+5px)] divide-y mr-1 dark:bg-black shadow-md rounded-md border w-[200px] z-10 pop-bg`}>
                <Button
                  variant="ghost"
                  className="dark:hover:bg-neutral-800 px-3 py-1 h-8 w-full  dark:bg-black dark:text-neutral-300 font-hel-heading flex justify-start gap-1"
                  onClick={() => {
