...
interface RegulationsTableProps {
  data: RegulationsValues[];
}

export const RegulationsTable = ({ data }: RegulationsTableProps) => {
...
const DraggableTableHeader = ({
  ...
  header: Header<RegulationsValues, unknown>;
}) => {
  const {
    attributes,
    isDragging,
...
const DragAlongCell = ({
  ...
  cell: Cell<RegulationsValues, unknown>;
}) => {
