        ...
        <Popover>
          ...
          <PopoverContent className="w-[250px] px-1 py-2 dark:bg-black">
            <div className="flex flex-col divide-y">
              ...
              {row.original.status === Status.NOT_STARTED ||
...
interface ReviewCommentsTableProps {
  data: ReviewCommentsValues[];
}

export const ReviewCommentsTable = ({ data }: ReviewCommentsTableProps) => {
...
const DraggableTableHeader = ({
  ...
  header: Header<ReviewCommentsValues, unknown>;
}) => {
  const {
    attributes,
    isDragging,
...
const DragAlongCell = ({
  ...
  cell: Cell<ReviewCommentsValues, unknown>;
}) => {
