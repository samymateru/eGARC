...
export const RolesSchema = z.object({
  ...
  settings: z.array(PermissionEnum).optional(),
  audit_plans: z.array(PermissionEnum).optional(),
  administration: z.array(PermissionEnum).optional(),
  planning: z.array(PermissionEnum).optional(),
  fieldwork: z.array(PermissionEnum).optional(),
  reporting: z.array(PermissionEnum).optional(),
  audit_program: z.array(PermissionEnum).optional(),
  follow_up: z.array(PermissionEnum).optional(),
  issue_management: z.array(PermissionEnum).optional(),
  others: z.array(PermissionEnum).optional(),
  archive_audit: z.enum(["yes", "no"]).optional().default("no"),
